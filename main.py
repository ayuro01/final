...
if chose == 1:
    ...
    print("Programming is the process of writing instructions, or code, that tell a computer what to do to solve a problem or perform a specific task.")
    ...
    print("complex: Numbers with a real and imaginary part (e.g., 1 + 2j)")
